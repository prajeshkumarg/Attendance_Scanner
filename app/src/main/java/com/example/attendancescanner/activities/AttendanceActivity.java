...
public class AttendanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        students_check = (ArrayList<String>) getIntent().getSerializableExtra("STUDENT_LIST");
        ...
        final CameraSource cameraSource = new CameraSource.Builder(this, barcodeDetector).setAutoFocusEnabled(true).setRequestedPreviewSize(1280,720).setRequestedFps(30).build();
